...
<header class="relative z-30 px-4 sm:px-6 py-4 lg:py-6 flex items-center justify-between">
  <!-- Dynamic Title Brand (Single source of truth: animates from center to top-left) -->
  <div class="transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform {session.hasStarted ? 'translate-x-0 translate-y-0 opacity-100' : 'fixed left-1/2 top-[22%] -translate-x-1/2 z-40 text-center pointer-events-none'}">
