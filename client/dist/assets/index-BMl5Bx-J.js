...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},jg=(e,t)=>new Yc(e,t)}),Qc,lo,Jc,ep,tp,rp,kt,Kg,Zg,Gr=U(()=>{ne(),oe(),Le(),le(),Qc=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},lo=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Jc=(e,t)=>R.sortBasedOnPerm(e,lo(e.length,t)),ep=(e,t,r,i)=>{let n=`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
  ...
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let _=R.size(a);return{outputs:[{dims:a,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64/4)},programUniforms:[{type:12,data:Math.ceil(_/4)}]}},getShaderSource:d};let{newShape:p,newPerm:f}=tp(e.dims,n),h=R.areEqual(f,[2,3,1]),m=R.areEqual(f,[3,1,2]);if(p.length===2||h||m){s=h?[p[0],p[1]*p[2]]:m?[p[0]*p[1],p[2]]:p,o=[s[1],s[0]];let _=16;return d=b=>{let $=D("a",r,s.length),v=ee("output",r,o.length);return`
...
var best_index : i32 = 0;`,`if (${i.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return{name:"AttentionProbs",shaderCache:{hint:`${$};${n!==void 0};${i!==void 0};${e}`,inputDependencies:C},getRunData:()=>({outputs:z,dispatchGroup:I,programUniforms:k}),getShaderSource:x}},Tp=(e,t,r,i,n,a,s=void 0,o=void 0)=>{let u=a+n.kvSequenceLength,d=n.nReps?n.nReps:1,p=n.vHiddenSize*d,f=e>1&&i,h=n.kvNumHeads?n.kvNumHeads:n.numHeads,m=f?[n.batchSize,h,u,n.headSize]:void 0,_=[n.batchSize,n.sequenceLength,p],b=12,$={x:Math.ceil(n.vHeadSize/b),y:Math.ceil(n.sequenceLength/b),z:n.batchSize*n.numHeads},v=[{type:12,data:n.sequenceLength},{type:12,data:u},{type:12,data:n.vHeadSize},{type:12,data:n.numHeads},{type:12,data:n.headSize},{type:12,data:p},{type:12,data:a},{type:12,data:n.kvSequenceLength},{type:12,data:d}],w=f&&i&&R.size(i.dims)>0,I=["type","type"];w&&I.push("type"),s&&I.push("type"),o&&I.push("type");let k=[{dims:_,dataType:t.dataType,gpuDataType:0}];f&&k.push({dims:m,dataType:t.dataType,gpuDataType:0});let T=C=>{let z=D("probs",t.dataType,t.dims),x=D("v",r.dataType,r.dims),N=[z,x];w&&N.push(D("past_value",i.dataType,i.dims));let P=s?D("seq_lens",s.dataType,s.dims):void 0;s&&N.push(P);let F=o?D("total_sequence_length_input",o.dataType,o.dims):void 0;o&&N.push(F);let j=[ee("output",t.dataType,_)];f&&j.push(ee("present_value",t.dataType,m));let Z=[{name:"M",type:"u32"},{name:"K",type:"u32"},{name:"N",type:"u32"},{name:"num_heads",type:"u32"},{name:"head_size",type:"u32"},{name:"v_hidden_size",type:"u32"},{name:"past_sequence_length",type:"u32"},{name:"kv_sequence_length",type:"u32"},{name:"n_reps",type:"u32"}];return`
  const TILE_SIZE = ${b}u;
  ...
  }`};return{name:"AttentionScore",shaderCache:{hint:`${i!==void 0};${e}`,inputDependencies:I},getRunData:()=>({outputs:k,dispatchGroup:$,programUniforms:v}),getShaderSource:T}},Fn=(e,t,r,i,n,a,s,o,u,d,p=void 0,f=void 0)=>{let h=Math.min(e.outputCount,1+(s?1:0)+(o?1:0)),m=h>1?s:void 0,_=h>1?o:void 0,b=h>1?d.pastSequenceLength:0,$=b+d.kvSequenceLength,v=u&&R.size(u.dims)>0?u:void 0,w=[t,r];m&&R.size(m.dims)>0&&w.push(m),v&&w.push(v),p&&w.push(p),f&&w.push(f);let I=e.compute(Ip(h,t,r,m,v,d,b,p,f),{inputs:w,outputs:h>1?[-1,1]:[-1]})[0];e.compute(kp(I,d.batchSize,d.numHeads,b,d.sequenceLength,$,p,f),{inputs:p&&f?[I,p,f]:[I],outputs:[]});let k=[I,i];_&&R.size(_.dims)>0&&k.push(_),p&&k.push(p),f&&k.push(f),e.compute(Tp(h,I,i,_,d,b,p,f),{inputs:k,outputs:h>1?[0,2]:[0]})},Ep=(e,t)=>{let r=[t.batchSize,t.numHeads,t.sequenceLength,t.headSize],i=t.sequenceLength,n=t.inputHiddenSize,a=t.headSize,s=12,o={x:Math.ceil(t.headSize/s),y:Math.ceil(t.sequenceLength/s),z:t.batchSize*t.numHeads},u=[e.inputs[0],e.inputs[1],e.inputs[2]],d=[{type:12,data:i},{type:12,data:n},{type:12,data:a},{type:12,data:t.numHeads},{type:12,data:t.headSize},{type:12,data:t.hiddenSize},{type:12,data:t.hiddenSize+t.hiddenSize+t.vHiddenSize}],p=f=>{let h=ee("output_q",u[0].dataType,r),m=ee("output_k",u[0].dataType,r),_=ee("output_v",u[0].dataType,r),b=D("input",u[0].dataType,u[0].dims),$=D("weight",u[1].dataType,u[1].dims),v=D("bias",u[2].dataType,u[2].dims),w=b.type.storage,I=[{name:"M",type:"u32"},{name:"K",type:"u32"},{name:"N",type:"u32"},{name:"num_heads",type:"u32"},{name:"head_size",type:"u32"},{name:"hidden_size",type:"u32"},{name:"ldb",type:"u32"}];return`
  const TILE_SIZE = ${s}u;
...
`,Dp=e=>`quick_gelu_impl(${e})`,t_=(e,t)=>{let r=nt(e.inputs[0].dataType);e.compute(Ie(e.inputs[0],"QuickGelu",Dp,Mp(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Pp,Up,r_,G1=U(()=>{oe(),le(),Ju(),Pp=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Up=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=D("input",e[0].dataType,e[0].dims,4),i=D("bias",e[0].dataType,[e[0].dims[2]],4),n=ee("output",e[0].dataType,t,4),a=R.size(t)/4,s=He(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:o=>`
  ...
  ${o.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${v}
      }`},Wp=(e,t,r,i,n,a,s=r.dataType)=>{let o=r.dims.map(Number),u=i.dims.map(Number),d=!R.areEqual(o,u),p=o,f=R.size(o),h=!1,m=!1,_=[d];if(d){let b=Qi.calcShape(o,u,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");p=b.slice(),f=R.size(p);let $=R.size(o)===1,v=R.size(u)===1,w=o.length>0&&o[o.length-1]%4===0,I=u.length>0&&u[u.length-1]%4===0;_.push($),_.push(v),_.push(w),_.push(I);let k=1;for(let T=1;T<p.length;T++){let C=o[o.length-T],z=u[u.length-T];if(C===z)k*=C;else break}k%4===0?(m=!0,h=!0):($||v||w||I)&&(h=!0)}else h=!0;return _.push(h),{name:e,shaderCache:{hint:t+_.map(b=>b.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:b=>Lp(b,o,u,p,h,d,m,n,r.dataType,i.dataType,s,a),getRunData:()=>({outputs:[{dims:p,dataType:s}],dispatchGroup:{x:Math.ceil(f/64/4)},programUniforms:[{type:12,data:Math.ceil(R.size(p)/4)},...ie(o,u,p)]})}},Gt=(e,t,r,i,n,a)=>{e.compute(Wp(t,n??"",e.inputs[0],e.inputs[1],r,i,a))},i_=e=>{Gt(e,"Add",(t,r)=>`${t}+${r}`)},n_=e=>{Gt(e,"Div",(t,r)=>`${t}/${r}`)},a_=e=>{Gt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},s_=e=>{Gt(e,"Mul",(t,r)=>`${t}*${r}`)},o_=e=>{let t=D("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Gt(e,"Pow",{scalar:(r,i)=>`pow_custom(${r},${i})`,vector:(r,i)=>`pow_vector_custom(${r},${i})`},`
...
`}return Y};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${f};${h};${m};${n}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:w}),getShaderSource:I}}}),Hp,jp,hu,fo,Kp,mu,Zp,as,nl=U(()=>{ne(),oe(),le(),Si(),il(),tl(),Hp=(e,t)=>e?`
        ...
        }`,hu=(e,t,r="f32",i,n=!1,a=32,s=!1,o=32)=>{let u=t[1]*e[1],d=t[0]*e[0],p=n?u:a,f=n?a:u,h=p/t[0],m=a/t[1];if(!((n&&h===4&&e[1]===4||!n&&(h===3||h===4))&&p%t[0]===0&&a%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${n} is true, innerElementSize ${h} and workPerThread[1] ${e[1]} must be 4.
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `,Kp=e=>e?"let ACached = mm_Asub[k][tileRow + innerRow];":"let ACached = mm_Asub[tileRow + innerRow][k];",mu=(e,t,r="f32",i,n=!1,a=32,s=!1,o=32,u=!1)=>{let d=e[1]*t[1],p=e[0]*t[0],f=n?d:a,h=n?a:d;if(!(h%t[1]===0&&f%t[0]===0&&a%t[1]===0))throw new Error(`tileAHight ${h} must be divisible by workgroupSize[1]${t[1]}, tileAWidth ${f} must be divisible by workgroupSize[0]${t[0]}, tileInner ${a} must be divisible by workgroupSize[1]${t[1]}`);let m=h/t[1],_=f/t[0],b=a/t[1],$=u?`
    let localRow = i32(localId.y);
...
`},Zp=(e,t,r,i,n=!1)=>{let[a,s,o,u]=i,d=He(i[0].type.tensor);return`
  ...
  ${b?hu($,v,K,Y):mu($,v,K,Y)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${T}) {
    ...
    }`},__=(e,t,r,i,n,a,s,o,u)=>{let d=t.format==="NHWC",p=d?e[0].dims[3]:e[0].dims[1],f=r[0],h=d?r[2]:r[3],m=d?r[1]:r[2],_=d?r[3]:r[1],b=d&&(p%4===0||p%3===0)&&_%4===0,$=d?_:h*m,v=d?h*m:_,w=[8,8,1],I=i<=8?[4,1,1]:[4,4,1],k=[Math.ceil($/w[0]/I[0]),Math.ceil(v/w[1]/I[1]),Math.ceil(f/w[2]/I[2])];we("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${k}`);let T=b?d&&p%4!==0?3:4:1,C=w[1]*I[1],z=w[0]*I[0],x=Math.max(w[0]*T,w[1]),N=i%C===0,P=n%z===0,F=a%x===0,j=b?[T,4,4]:[1,1,1],Z=[{type:6,data:i},{type:6,data:n},{type:6,data:a},{type:6,data:[t.pads[0],t.pads[1]]},{type:6,data:t.strides},{type:6,data:t.dilations}];wi(t,Z),Z.push(...ie(e[0].dims,e[1].dims));let B=["rank","rank"];s&&(Z.push(...ie(e[2].dims)),B.push("rank")),Z.push(...ie(r));let Y=K=>{let J=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"pad",type:"i32",length:2},{name:"stride",type:"i32",length:2},{name:"dilation",type:"i32",length:2}];$i(t,J);let be=b?4:1,L=He(e[0].dataType),de=`
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${b?`vec4<${L}>`:L}) {
        ...
        ${b?hu(I,w,L,void 0,!d,x):mu(I,w,L,void 0,!d,x,!1,void 0,o)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${T};${b};${N};${P};${F};${C};${z};${x}`,inputDependencies:B},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:e[0].dataType}],dispatchGroup:{x:k[0],y:k[1],z:k[2]},programUniforms:Z}),getShaderSource:Y}}}),Yp,ho,$n,Qp,mo,Jp,y_,b_,j1=U(()=>{ne(),Ir(),oe(),le(),Si(),tl(),Yp=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},ho=e=>typeof e=="number"?[e,e,e]:e,$n=(e,t)=>t<=1?e:e+(e-1)*(t-1),Qp=(e,t,r,i=1)=>{let n=$n(t,i);return Math.floor((e[0]*(r-1)-r+n)/2)},mo=(e,t,r,i,n)=>{n==null&&(n=Qp(e,t[0],i[0]));let a=[0,0,0,r];for(let s=0;s<3;s++)e[s]+2*n>=t[s]&&(a[s]=Math.trunc((e[s]-t[s]+2*n)/i[s]+1));return a},Jp=(e,t,r,i,n,a,s,o,u,d)=>{let p,f,h,m;if(e==="VALID"&&(e=0),typeof e=="number"){p={top:e,bottom:e,left:e,right:e,front:e,back:e};let _=mo([t,r,i,1],[o,u,d],1,[n,a,s],e);f=_[0],h=_[1],m=_[2]}else if(Array.isArray(e)){if(!e.every((b,$,v)=>b===v[0]))throw Error(`Unsupported padding parameter: ${e}`);p={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let _=mo([t,r,i,1],[o,u,d],1,[n,a,s],e[0]);f=_[0],h=_[1],m=_[2]}else if(e==="SAME_UPPER"){f=Math.ceil(t/n),h=Math.ceil(r/a),m=Math.ceil(i/s);let _=(f-1)*n+o-t,b=(h-1)*a+u-r,$=(m-1)*s+d-i,v=Math.floor(_/2),w=_-v,I=Math.floor(b/2),k=b-I,T=Math.floor($/2),C=$-T;p={top:I,bottom:k,left:T,right:C,front:v,back:w}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:p,outDepth:f,outHeight:h,outWidth:m}},y_=(e,t,r,i,n,a=!1,s="channelsLast")=>{let o,u,d,p,f;if(s==="channelsLast")[o,u,d,p,f]=e;else if(s==="channelsFirst")[o,f,u,d,p]=e;else throw new Error(`Unknown dataFormat ${s}`);let[h,,m,_,b]=t,[$,v,w]=ho(r),[I,k,T]=ho(i),C=$n(m,I),z=$n(_,k),x=$n(b,T),{padInfo:N,outDepth:P,outHeight:F,outWidth:j}=Jp(n,u,d,p,$,v,w,C,z,x),Z=a?h*f:h,B=[0,0,0,0,0];return s==="channelsFirst"?B=[o,Z,P,F,j]:s==="channelsLast"&&(B=[o,P,F,j,Z]),{batchSize:o,dataFormat:s,inDepth:u,inHeight:d,inWidth:p,inChannels:f,outDepth:P,outHeight:F,outWidth:j,outChannels:Z,padInfo:N,strideDepth:$,strideHeight:v,strideWidth:w,filterDepth:m,filterHeight:_,filterWidth:b,effectiveFilterDepth:C,effectiveFilterHeight:z,effectiveFilterWidth:x,dilationDepth:I,dilationHeight:k,dilationWidth:T,inShape:e,outShape:B,filterShape:t}},b_=(e,t,r,i,n,a)=>{let s=a==="channelsLast";s?e[0].dims[3]:e[0].dims[1];let o=[64,1,1],u={x:r.map(($,v)=>v)},d=[Math.ceil(Yp(u.x.map($=>r[$]))/o[0]),1,1];we("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${d}`);let p=1,f=R.size(r),h=[{type:12,data:f},{type:12,data:i},{type:12,data:n},{type:12,data:t.strides},{type:12,data:t.dilations}];wi(t,h),h.push(...ie(e[0].dims,e[1].dims));let m=["rank","rank"],_=e.length===3;_&&(h.push(...ie(e[2].dims)),m.push("rank")),h.push(...ie(r));let b=$=>{let v=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:i.length},{name:"pads",type:"u32",length:n.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];$i(t,v);let w=1,I=He(e[0].dataType),k=D("x",e[0].dataType,e[0].dims.length,p),T=D("W",e[1].dataType,e[1].dims.length,w),C=[k,T],z=ee("result",e[0].dataType,r.length,w),x="";if(_){let F=D("bias",e[2].dataType,e[2].dims.length,w);C.push(F),x+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${I} {
          return bias[${s?te("coords",4,5):te("coords",1,5)}];
        }`}let N=Ke(p,I),P=vi(t,N,I);return`
            ${x}
  ...
  ${_.mainStart()}
      ...
      ${b.set("batch","row","col + i","output_channel","value")};
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${a};${s};${h};${d[0]};${d[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:f}),getShaderSource:m}}}),ef,Ca,tf,za,gu,go,rf,nf,_u,Z1=U(()=>{oe(),H1(),j1(),nl(),K1(),Si(),il(),Gr(),ef=(e,t,r,i,n,a)=>{let s=e[0],o=e.slice(a?1:2,a?3:4),u=o.length,d=t[0],p=t.slice(2).map((h,m)=>h+(h-1)*(r[m]-1)),f=o.map((h,m)=>h+i[m]+i[m+u]).map((h,m)=>Math.floor((h-p[m]+n[m])/n[m]));return f.splice(0,0,s),f.splice(a?3:1,0,d),f},Ca=[2,3,1,0],tf=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],i=e[1].dims[1]*t.group;if(r!==i)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},za=(e,t)=>{let r=e.kernelShape.slice();r.length<t[1].dims.length-2&&r.push(...Array(t[1].dims.length-2-r.length).fill(0));for(let a=2;a<t[1].dims.length;++a)r[a-2]===0&&(r[a-2]=t[1].dims[a]);let i=e.pads.slice();is.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,i,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:r,pads:i}),n},gu=e=>{let t=el(e),r=e.format,i=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,a=e.group,s=e.kernel_shape,o=e.pads,u=e.strides,d=e.w_is_const();return{autoPad:i,format:r,dilations:n,group:a,kernelShape:s,pads:o,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},go=(e,t,r,i)=>{let n=r.format==="NHWC",a=ef(t[0].dims,t[1].dims,r.dilations,r.pads,r.strides,n);if(r.group!==1){let C=[t[0]];if(n){let z=e.kernelCustomData.wT??e.compute(kt(t[1],Ca),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=z),C.push(z)}else C.push(t[1]);t.length===3&&C.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&n&&t[1].dims[0]===r.group&&t[1].dims[1]===1&&r.dilations[0]===1&&r.dilations[1]===1?e.compute(w_(C,r,a,i),{inputs:C}):e.compute(v_(C,r,a,i),{inputs:C});return}let s=t.length===3,o=t[0].dims[n?1:2],u=t[0].dims[n?2:3],d=t[0].dims[n?3:1],p=t[1].dims[2],f=t[1].dims[3],h=a[n?1:2],m=a[n?2:3],_=a[n?3:1],b=n&&p===o&&f===u&&r.pads[0]===0&&r.pads[1]===0;if(b||p===1&&f===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let C=a[0],z,x,N,P=[];if(n){let Z=e.kernelCustomData.wT??e.compute(kt(t[1],Ca),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=Z),b){let B=o*u*d;z=t[0].reshape([1,C,B]),x=Z.reshape([1,B,_]),N=[1,C,_]}else z=t[0].reshape([C,o*u,d]),x=Z.reshape([1,d,_]),N=[C,h*m,_];P.push(z),P.push(x)}else z=t[0].reshape([C,d,o*u]),x=t[1].reshape([1,_,d]),N=[C,_,h*m],P.push(x),P.push(z);s&&P.push(t[2]);let F=N[2],j=P[0].dims[P[0].dims.length-1];F<8&&j<8?e.compute(rl(P,r,a,N,n,i),{inputs:P}):e.compute(as(P,r,a,N,n,i),{inputs:P});return}let $=!0,v=e.kernelCustomData.wT??e.compute(kt(t[1],Ca),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=v);let w=[t[0],v];s&&w.push(t[2]);let I=n?h*m:_,k=n?_:h*m,T=p*f*d;e.compute(__(w,r,a,I,k,T,s,$,i),{inputs:w})},rf=(e,t)=>{let r=t.format==="NHWC",i=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&i.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],a=[1].concat(t.strides),s=[1].concat(t.dilations),o=[1].concat(t.kernelShape),u=za({...t,pads:n,strides:a,dilations:s,kernelShape:o},i);go(e,i,u,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},nf=(e,t,r)=>{let i=r.format==="NHWC"?"channelsLast":"channelsFirst",n=za(r,t),a=r.autoPad==="NOTSET"?r.pads:r.autoPad,s=y_(t[0].dims,t[1].dims,r.strides,r.dilations,a,!1,i);e.compute(b_(t,n,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],i))},_u=(e,t)=>{if(tf(e.inputs,t),e.inputs[0].dims.length===3)rf(e,t);else if(e.inputs[0].dims.length===5)nf(e,e.inputs,t);else{let r=za(t,e.inputs);go(e,e.inputs,r)}}}),$_,X1=U(()=>{ne(),Ir(),oe(),le(),$_=(e,t,r)=>{let i=e.length>2,n=t.outputShape,a=t.format==="NHWC",s=t.group,o=e[1].dims,u=o[2]/s,d=o[3],p=a?De(u):1,f=a&&d===1&&u>=4,h=f?Math.floor(u/4)*4:Math.floor(u/p)*p,m=u-h,_=a?De(d):1,b=a?d===1?p:_:1,$=R.size(n)/_,v=[Math.ceil($/64),1,1];we("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${v}`);let w=["rank","rank"],I=[t.strides[0],t.strides[1]],k=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],T=[t.dilations[0],t.dilations[1]],C=[k[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),k[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],z=[C[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),C[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],x=[{type:12,data:$},{type:12,data:I},{type:12,data:k},{type:12,data:T},{type:12,data:C},{type:6,data:z},{type:12,data:h},{type:12,data:u},{type:12,data:d},...ie(e[0].dims,e[1].dims)];i&&(x.push(...ie(e[2].dims)),w.push("rank")),x.push(...ie(n));let N=P=>{let F=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:I.length},{name:"filter_dims",type:"u32",length:k.length},{name:"dilations",type:"u32",length:k.length},{name:"effective_filter_dims",type:"u32",length:C.length},{name:"pads",type:"i32",length:z.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],j=He(e[0].dataType),Z=a?1:2,B=a?2:3,Y=a?3:1,K=D("W",e[1].dataType,e[1].dims.length,b),J=D("Dy",e[0].dataType,e[0].dims.length,p),be=[J,K];i&&be.push(D("bias",e[2].dataType,[n[Y]].length,_));let L=ee("result",e[0].dataType,n.length,_),de=()=>{let Q="";if(f)p===4?Q+=`
        ...
        `,p===1)Q+=`
          ...
          dotProd = dotProd + xValue * wValue;`;else for(let G=0;G<p;G++)Q+=`
            ...
            dotProd = dotProd + xValue[${G}] * wValue${G};`;return Q},W=()=>{if(m===0)return"";if(!f)throw new Error(`packInputAs4 ${f} is not true.`);let Q="";if(p===1){Q+="dotProd = dotProd";for(let G=0;G<m;G++)Q+=`
    ...
    ${H}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${p}${b}${_}${f}${m}`,inputDependencies:w},getRunData:()=>({dispatchGroup:{x:v[0],y:v[1],z:v[2]},outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],programUniforms:x}),getShaderSource:N}}}),af,sf,of,_o,x_,uf,yo,lf,S_,Y1=U(()=>{X1(),Si(),Gr(),af=(e,t,r,i,n,a)=>(e-1)*t+r+(i-1)*n+1-a,sf=(e,t,r,i,n)=>{let a=Math.floor(e/2);t==="SAME_UPPER"?(r[i]=a,r[n]=e-a):t==="SAME_LOWER"&&(r[i]=e-a,r[n]=a)},of=(e,t,r,i,n,a,s,o,u,d)=>{let p=e.length-2,f=d.length===0;u.length<p&&u.push(...Array(p-u.length).fill(0));let h=e[0],m=t[o?3:1]*n;for(let _=0,b=e.length-p-(o?1:0);_<p;++_,++b){let $=e[b],v=f?$*s[_]:d[_],w=af($,s[_],a[_],t[b],r[_],v);sf(w,i,a,_,_+p),f&&d.push(s[_]*($-1)+u[_]+(t[b]-1)*r[_]+1-a[_]-a[_+p])}d.splice(0,0,h),d.splice(o?3:1,0,m)},_o=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((f,h)=>f*h,1)===0){r.length=0;for(let f=2;f<t[1].dims.length;++f)r.push(t[1].dims[f])}let i=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(i?3:1,0,t[1].dims[1]);let n=e.pads.slice(),a=e.outputShape.slice(),s=e.outputPadding.slice(),o=t[0].dims,u=e.dilations.slice();if(u.reduce((f,h)=>f+h,0)===0){let f=t[0].dims.length-2;u=new Array(f).fill(1)}let d=e.strides.slice();if(d.reduce((f,h)=>f+h,0)===0){let f=t[0].dims.length-2;d=new Array(f).fill(1)}of(o,r,u,e.autoPad,e.group,n,d,i,s,a);let p=Object.assign({},e);return Object.assign(p,{kernelShape:r,pads:n,outputPadding:s,outputShape:a,dilations:u,strides:d}),p},x_=e=>{let t=el(e),r=e.format,i=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,a=e.group??1,s=e.kernelShape,o=e.pads,u=e.strides,d=e.wIsConst(),p=e.outputPadding,f=e.outputShape;return{autoPad:i,format:r,dilations:n,group:a,kernelShape:s,outputPadding:p,outputShape:f,pads:o,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},uf=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],i=e[1].dims[0];if(r!==i)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.reduce((s,o)=>s+o,0)>0&&t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.reduce((s,o)=>s+o,0)>0&&t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.reduce((s,o)=>s+o,0)>0&&t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.outputPadding.length!==a&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${a}D`);if(t.kernelShape.reduce((s,o)=>s+o,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},yo=(e,t,r,i)=>{let n=e.kernelCustomData.wT??e.compute(kt(t[1],[2,3,0,1]),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=n);let a=[t[0],n];t.length===3&&a.push(t[2]),e.compute($_(a,r,i),{inputs:a})},lf=(e,t)=>{let r=t.format==="NHWC",i=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&i.push(e.inputs[2]);let n=t.kernelShape;(n.length===0||n[0]===0)&&(n=[e.inputs[1].dims[2]]);let a=t.dilations;(a.length===0||a[0]===0)&&(a=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let o=t.pads;o.length===0&&(o=[0,0]),o=[0,o[0],0,o[1]],s=[1].concat(s),a=[1].concat(a),n=[1].concat(n);let u=t.outputPadding;u=[0].concat(u);let d=_o({...t,pads:o,strides:s,dilations:a,kernelShape:n,outputPadding:u},i);yo(e,i,d,p=>r?[p[0],p[2],p[3]]:[p[0],p[1],p[3]])},S_=(e,t)=>{if(uf(e.inputs,t),e.inputs[0].dims.length===3)lf(e,t);else{let r=_o(t,e.inputs);yo(e,e.inputs,r)}}}),df,k_,I_,Q1=U(()=>{ne(),oe(),Le(),le(),df=(e,t,r,i)=>{let n=R.size(t),a=t.length,s=D("input",e,a),o=ee("output",e,a),u=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),d=R.normalizeAxis(u,a),p=f=>{let h=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,m=te("uniforms.input_shape","uniforms.axis",a),_=i.reverse?h+(i.exclusive?" + 1":""):"0",b=i.reverse?m:h+(i.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:i.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:[{type:12,data:n},{type:12,data:d},...ie(t,t)]}),getShaderSource:p}},k_=(e,t)=>{let r=e.inputs[0].dims,i=e.inputs[0].dataType,n=e.inputs[1];e.compute(df(i,r,n,t),{inputs:[0]})},I_=e=>{let t=e.exclusive===1,r=e.reverse===1;return Te({exclusive:t,reverse:r})}}),cf,pf,ff,T_,E_,J1=U(()=>{ne(),oe(),Le(),le(),cf=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},pf=(e,t,r,i)=>{let n=[];n.push(`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let a=0;a<t;++a)n.push(r.indicesSet("a",e[a],`i[${a}]`));return n.push("return a;}"),n.join(`
`)},ff=(e,t)=>{let r,i,n,a,s,o,u=t.format==="NHWC",d=t.blocksize,p=t.mode==="DCR";u?([r,i,n,a]=e.dims,s=p?[r,i,n,d,d,a/d**2]:[r,i,n,a/d**2,d,d],o=p?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,i,n,a]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],s=p?[r,d,d,a/d**2,i,n]:[r,a/d**2,d,d,i,n],o=p?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let f=e.reshape(s),h=f.dims.length,m=e.dataType,_=D("a",m,h),b=ee("output",m,h),$=v=>`
...
`)};
    ...
    ${s.mainStart(Ji)}
      ...
      ${h.mainStart()}
        ...
        ${v}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:s,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:p}),getShaderSource:f}},B_=e=>Te({axis:e.axis}),R_=(e,t)=>{let r=e.inputs;xf(r),e.compute(Sf(e.inputs,t))}}),kf,N_,M_,n2=U(()=>{ne(),oe(),le(),kf=(e,t,r,i,n,a,s,o,u)=>{let d=[{type:12,data:a},{type:12,data:i},{type:12,data:n},{type:12,data:r},{type:12,data:s},{type:12,data:o},{type:12,data:u}],p=[a];d.push(...ie(t.dims,p));let f=h=>{let m=D("indices_data",t.dataType,t.dims.length),_=ee("input_slice_offsets_data",12,1,1),b=[m,_],$=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:n.length},{name:"sizes_from_slice_dims_data",type:"u32",length:r.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
...
`,Pf=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d}),getShaderSource:p},{inputs:[t,r],outputs:[-1]})[0]},Dn=(e,t,r,i,n,a,s,o)=>{let u=a;if(s&&R.size(s.dims)>0){if(i===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=Wf(e,a,s,t,i,r*n,o),u=u.reshape([t,i,r,n]),r===1||i===1?u:e.compute(kt(u,$o.perm),{inputs:[u],outputs:[-1]})[0]}else return a.dims.length===3&&(u=a.reshape([t,i,r,n])),r===1||i===1?u:e.compute(kt(u,$o.perm),{inputs:[u],outputs:[-1]})[0]},H_=(e,t)=>{let r=Lf(e.inputs,t),i=e.inputs[0],n=ot(e.inputs,1),a=ot(e.inputs,2),s=ot(e.inputs,3),o=ot(e.inputs,4),u=ot(e.inputs,5),d=ot(e.inputs,6),p=ot(e.inputs,7);if(i.dims.length===5)throw new Error("Packed QKV is not implemented");if((n==null?void 0:n.dims.length)===5)throw new Error("Packed KV is not implemented");let f=n&&a&&n.dims.length===4&&a.dims.length===4,h=Dn(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,i,s,0);if(f)return Fn(e,h,n,a,o,void 0,d,p,u,r);if(!n||!a)throw new Error("key and value must be provided");let m=Dn(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,n,s,r.hiddenSize),_=Dn(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,a,s,2*r.hiddenSize);Fn(e,h,m,_,o,void 0,d,p,u,r)}}),Gf,qf,Vf,Ff,yu,K_,Z_,X_=U(()=>{ne(),oe(),Le(),le(),Gf=e=>{if(!e||e.length<1)throw new Error("too few inputs")},qf=(e,t)=>{let r=[],i=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),i=r.length),Te({numOutputs:i,axis:t.axis,splitSizes:r})},Vf=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
      ...
      fn writeBufferData(output_number: u32, indices: ${e[0].type.indices}, global_idx: u32) {
        ${r.join(`
`)}
      }`},yu=(e,t)=>{let r=e[0].dims,i=R.size(r),n=e[0].dataType,a=R.normalizeAxis(t.axis,r.length),s=new Array(t.numOutputs),o=D("input",n,r.length),u=new Array(t.numOutputs),d=[],p=[],f=0,h=[{type:12,data:i}];for(let _=0;_<t.numOutputs;_++){f+=t.splitSizes[_],u[_]=f;let b=r.slice();b[a]=t.splitSizes[_],p.push(b),s[_]=ee(`output${_}`,n,b.length),d.push({dims:p[_],dataType:e[0].dataType})}h.push({type:12,data:u},...ie(r,...p));let m=_=>`
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:m,getRunData:()=>({outputs:d,dispatchGroup:{x:Math.ceil(i/64)},programUniforms:h})}},K_=(e,t)=>{Gf(e.inputs);let r=e.inputs.length===1?t:qf(e.inputs,t);e.compute(yu(e.inputs,r),{inputs:[0]})},Z_=e=>{let t=e.axis,r=e.splitSizes,i=e.numOutputs<0?r.length:e.numOutputs;if(i!==r.length)throw new Error("numOutputs and splitSizes length must be equal");return Te({axis:t,numOutputs:i,splitSizes:r})}}),Hf,ss,Y_,Q_=U(()=>{ne(),oe(),Le(),le(),Hf=(e,t)=>{let[r,i,n,a]=e,{numHeads:s,rotaryEmbeddingDim:o}=t;if(r.dims.length!==3&&r.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${r.dims.length}`);if(!R.areEqual(i.dims,[])&&!R.areEqual(i.dims,[1])&&i.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${i.dims.length}`);if(n.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${n.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(!R.areEqual(n.dims,a.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(o>0&&s===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let u=r.dims[0],d=r.dims[r.dims.length-2],p=n.dims[0],f=R.sizeFromDimension(r.dims,1)/d,h=o===0?n.dims[1]*2:f/s;if(o>h)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(i.dims.length===2){if(u!==i.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${i.dims[0]}`);if(d!==i.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${i.dims[1]}`)}if(d>p)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported");if(h/2!==n.dims[1]&&o/2!==n.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${n.dims[1]}`)},ss=(e,t)=>{let{interleaved:r,numHeads:i,rotaryEmbeddingDim:n,scale:a}=t,s=e[0].dims[0],o=R.sizeFromDimension(e[0].dims,1),u=e[0].dims[e[0].dims.length-2],d=o/u,p=e[2].dims[1],f=n===0?p*2:d/i,h=new Array(s,u,d/f,f-p),m=R.computeStrides(h),_=[{type:1,data:a},{type:12,data:h},{type:12,data:m},...e[0].dims.length===3?new Array({type:12,data:[o,d,f,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[o,f,u*f,1]}):[],...ie(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],b=$=>{let v=D("input",e[0].dataType,e[0].dims.length),w=D("position_ids",e[1].dataType,e[1].dims.length),I=D("cos_cache",e[2].dataType,e[2].dims.length),k=D("sin_cache",e[3].dataType,e[3].dims.length),T=ee("output",e[0].dataType,e[0].dims.length);return $.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:h.length},{name:"global_strides",type:"u32",length:m.length},{name:"input_output_strides",type:"u32",length:m.length}]),`
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:a},getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:u}),getShaderSource:d}},J_=(e,t)=>{var k;let r=jf(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((k=e.inputs[1])==null?void 0:k.dims.length)===5)throw new Error("Packed KV is not implemented");let i=e.inputs[0],n=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,a=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,s=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,o=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,d=e.inputs.length>5?e.inputs[6]:void 0,p=r.kvNumHeads?r.kvNumHeads:r.numHeads,f=Te({axis:2,numOutputs:3,splitSizes:[r.numHeads*r.headSize,p*r.headSize,p*r.headSize]}),[h,m,_]=!n&&!a?e.compute(yu([i],f),{inputs:[i],outputs:[-1,-1,-1]}):[i,n,a],b,$;if(t.doRotary){let T=e.compute(Zf(r.batchSize,r.sequenceLength,u,d),{inputs:[u,d],outputs:[-1]})[0],C=e.inputs[7],z=e.inputs[8],x=Te({interleaved:t.rotaryInterleaved!==0,numHeads:r.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),N=[h,T,C,z],P=[-1];b=e.compute(ss(N,x),{inputs:N,outputs:P})[0],N.splice(0,1,m);let F=Te({interleaved:t.rotaryInterleaved!==0,numHeads:r.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});$=e.compute(ss(N,F),{inputs:N,outputs:P})[0]}let v=Dn(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,t.doRotary?b:h,void 0,0),w=xo(e,t.doRotary?$:m,r),I=xo(e,_,r);Fn(e,v,w,I,void 0,void 0,s,o,void 0,r,u,d)}}),So,Xf,Yf,ey,d2=U(()=>{ne(),oe(),Gr(),le(),So=(e,t,r,i,n,a,s,o)=>{let u=De(a),d=u===1?"f32":`vec${u}f`,p=u===1?"vec2f":`mat2x${u}f`,f=n*s,h=64;f===1&&(h=256);let m=[n,s,a/u],_=[n,s,2],b=["rank","type","type"],$=[];$.push(...ie(m,_));let v=w=>{let I=D("x",t.dataType,3,u),k=D("scale",r.dataType,r.dims),T=D("bias",i.dataType,i.dims),C=ee("output",1,3,2),z=[I,k,T,C];return`
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${d}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:[{type:12,data:p},...ie(h,m,h)]}),getShaderSource:b},{inputs:[t[0],f]})},Yf=(e,t,r)=>{let i=t[0].dims,n=i,a=i[0],s=i[i.length-1],o=R.sizeFromDimension(i,1)/s,u=De(s),d=R.size(n)/u,p=[{type:12,data:o},{type:12,data:Math.floor(s/u)}],f=["type","type"],h=!1,m=[0,i.length-1];for(let v=0;v<i.length-2;v++)h=h||i[v+1]!==1,m.push(v+1);h=h&&i[i.length-1]!==1;let _=h?e.compute(kt(e.inputs[0],m),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:i.length},(v,w)=>i[m[w]])),b=So(e,_,t[1],t[2],a,o,s,r.epsilon),$=v=>{let w=He(t[0].dataType),I=u===1?"vec2f":`mat${u}x2f`,k=z=>{let x=z===0?"x":"y",N=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${w}(${N}(scale.${x}))`;case 2:return`vec2<${w}>(${N}(scale[0].${x}, scale[1].${x}))`;case 4:return`vec4<${w}>(${N}(scale[0].${x}, scale[1].${x}, scale[2].${x}, scale[3].${x}))`;default:throw new Error(`Not supported compoents ${u}`)}},T=D("input",t[0].dataType,t[0].dims,u),C=ee("output",t[0].dataType,n,u);return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:p}),getShaderSource:$},{inputs:[t[0],b]})},ey=(e,t)=>{t.format==="NHWC"?Yf(e,e.inputs,t):Xf(e,e.inputs,t)}}),Qf,Jf,ty,c2=U(()=>{ne(),oe(),le(),Qf=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Jf=(e,t,r)=>{let i=t.simplified,n=e[0].dims,a=e[1],s=!i&&e[2],o=n,u=R.normalizeAxis(t.axis,n.length),d=R.sizeToDimension(n,u),p=R.sizeFromDimension(n,u),f=R.size(a.dims),h=s?R.size(s.dims):0;if(f!==p||s&&h!==p)throw new Error(`Size of X.shape()[axis:] == ${p}.
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${yh(t.reduction,"output[data_offset + i]","value",_.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:p}},_y=e=>Te({reduction:e.reduction}),yy=(e,t)=>{e.compute(bh(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),vh,wh,$h,Bo,xh,Sh,kh,Ih,Th,Eh,Ch,zh,Ro,Ah,Oh,Bh,Rh,Nh,by,vy,b2=U(()=>{ne(),oe(),Le(),le(),vh=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},wh=(e,t,r)=>{t.every(n=>n>=0&&n<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let i=new Array(r).fill(1);return t.forEach((n,a)=>i[n]=e[a]),i},$h=(e,t,r,i,n,a)=>{let[s,o,u]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],d=e[0].dims.length;if(s>0&&e.length>s&&e[s].dims.length>0)e[s].getFloat32Array().forEach(p=>a.push(p));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(o>0&&e.length>o&&e[o].dims.length===1&&e[o].dims[0]>0){if(e[o].getFloat32Array().forEach(p=>i.push(p)),i.length!==0&&i.length!==d&&r>=18&&i.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");vh(i,t),t.axes.length>0&&wh(i,t.axes,d).forEach((p,f)=>i[f]=p)}if(u>0&&e.length>u&&e[u].dims.length===1&&e[u].dims[0]>0&&(e[u].getBigInt64Array().forEach(p=>n.push(Number(p))),n.length!==0&&n.length!==d&&r>=18&&n.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(i.length!==0&&i.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(n.length!==0&&n.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof i<"u"&&typeof n<"u"&&i.length>0&&n.length>d)throw new Error("Resize requires only of scales or sizes to be specified")},Bo=(e,t,r,i)=>`
...
`:"",Ah=(e,t,r,i,n)=>{let[a,s,o,u]=r.length===2?[-1,0,1,-1]:[0,2,3,1],d=e.type.value;return`
    ...
    }`},Oh=(e,t,r,i,n,a,s,o,u,d)=>{let p=r.length===2,[f,h]=p?[0,1]:[2,3],m=e.type.value,_=b=>{let $=b===f?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    `},Bh=(e,t,r,i,n)=>{let[a,s,o,u,d]=r.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],p=e.type.value;return`
    ...
    }`},Rh=(e,t,r,i,n,a)=>{let s=e.dims,o=kh(a,t.axes,s.length),u=Ih(s,i,n,t.axes),d=i.slice();i.length===0&&(d=s.map((w,I)=>w===0?1:u[I]/w),t.keepAspectRatioPolicy!=="stretch"&&(u=Th(s,d,t)));let p=ee("output",e.dataType,u.length),f=D("input",e.dataType,s.length),h=R.size(u),m=s.length===u.length&&s.every((w,I)=>w===u[I]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,$=f.type.value,v=w=>`
      ${m?"":`
      ${xh(t.coordinateTransformMode,$)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${zh(f,s)};
              ${Sh(t.nearestMode,r,$)};
              ${Ch(f,p,s,u,d.length,o.length,_)};
              `;case"linear":return`
              ${Eh(p,s,u,d.length,o.length)};
              ${(()=>{if(s.length===2||s.length===4)return`${Ah(f,p,s,_,b)}`;if(s.length===3||s.length===5)return`${Bh(f,p,s,_,b)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(s.length===2||s.length===4)return`${Oh(f,p,s,u,d,o,t.cubicCoeffA,_,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${a.length}`,inputDependencies:["rank"]},getShaderSource:$,getRunData:()=>({outputs:[p],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:b})}},$y=(e,t)=>{Ph(e.inputs,t);let r=Uh(e.inputs,t);e.compute(Wh(e.inputs,r),{inputs:[0]})},xy=e=>{let t=e.starts,r=e.ends,i=e.axes;return Te({starts:t,ends:r,axes:i})}}),Gh,qh,Sy,ky,$2=U(()=>{ne(),oe(),Le(),Gr(),le(),Gh=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},qh=(e,t)=>{let r=e.inputs[0],i=r.dims,n=R.size(i),a=i.length,s=R.normalizeAxis(t.axis,a),o=s<i.length-1,u,d=[];o?(d=Array.from({length:a},(z,x)=>x),d[s]=a-1,d[a-1]=s,u=e.compute(kt(r,d),{inputs:[r],outputs:[-1]})[0]):u=r;let p=u.dims,f=p[a-1],h=n/f,m=De(f),_=f/m,b=64;h===1&&(b=256);let $=(z,x)=>x===4?`max(max(${z}.x, ${z}.y), max(${z}.z, ${z}.w))`:x===2?`max(${z}.x, ${z}.y)`:x===3?`max(max(${z}.x, ${z}.y), ${z}.z)`:z,v=D("x",u.dataType,u.dims,m),w=ee("result",u.dataType,u.dims,m),I=v.type.value,k=He(u.dataType)==="f32"?`var threadMax = ${I}(-3.4028234663852886e+38f);`:`var threadMax = ${I}(-65504.0h);`,T=z=>`
